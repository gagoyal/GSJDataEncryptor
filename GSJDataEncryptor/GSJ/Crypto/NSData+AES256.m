...
// This code is modified to enable searching and querying of core data objects.
...
const NSUInteger kPBKDFRounds = 512;
...
- (NSData *)encryptedDataWithPassword:(NSString *)password
    ...
    *iv = [defaults objectForKey:@"iv"];
    if (*iv == nil) {
        *iv = [DataGenerator createRandomDataOfLength:kAlgorithmIVSize];
        [defaults setObject:*iv forKey:@"iv"];
        [defaults synchronize];
    }

    *salt = [defaults objectForKey:@"salt"];
    if (*salt == nil) {
